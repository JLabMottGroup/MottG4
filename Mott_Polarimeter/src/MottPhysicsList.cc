...
//
//
// $Id: MottPhysicsList.cc,v 3.7 2013/08/14 15:58:14 mjmchugh Exp $
//
...
MottPhysicsList::~MottPhysicsList()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void MottPhysicsList::ConstructParticle()
{
...
void MottPhysicsList::ConstructLeptons()
{
  // leptons
  //  e+/-
...
void MottPhysicsList::ConstructMesons()
{
  //  mesons
  //    light mesons
...
void MottPhysicsList::ConstructBaryons()
{
  //  barions
...
void MottPhysicsList::ConstructEM()
{
...
void MottPhysicsList::ConstructGeneral()
{
  G4PhysicsListHelper* ph = G4PhysicsListHelper::GetPhysicsListHelper();
...
// Optical Photon Processes to accurately describe scintillators (hopefully)
...
void MottPhysicsList::AddStepMax()
{
